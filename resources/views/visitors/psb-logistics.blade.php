                ...
                <div class="col-sm-6">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/psb_logistics/PSB-01.jpg" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-sm-6">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/psb_logistics/PSB-02.jpg" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-sm-6">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/psb_logistics/PSB-03.jpg" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-sm-6">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/psb_logistics/PSB-04.jpg" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-sm-6">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/psb_logistics/PSB-05.jpg" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-sm-6">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/psb_logistics/PSB-06.jpg" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-sm-6">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/psb_logistics/PSB-07.jpg" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-sm-6">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/psb_logistics/PSB-08.jpg" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-sm-6">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/psb_logistics/PSB-09.jpg" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-sm-6">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/psb_logistics/PSB-10.jpg" alt="img">
                        </div>
                    </a>
                </div>
            </div>
