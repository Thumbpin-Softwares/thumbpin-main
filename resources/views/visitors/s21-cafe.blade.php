                ...
                <div class="col-12">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/s21-cafe/1.png" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-12">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/s21-cafe/2.png" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-12">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/s21-cafe/3.png" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-12">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/s21-cafe/4.png" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-12">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/s21-cafe/5.png" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-12">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/s21-cafe/6.png" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-12">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/s21-cafe/7.png" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-12">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/s21-cafe/8.png" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-12">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/s21-cafe/9.png" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-12">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/s21-cafe/10.png" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-12">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/s21-cafe/11.png" alt="img">
                        </div>
                    </a>
                </div>
                <div class="col-12">
                    <a class="card-3">
                        <div class="card-content">
                            ...
                            <img src="{{ config('app.url') }}/assets/img/work/print/s21-cafe/12.png" alt="img">
                        </div>
                    </a>
                </div>
            </div>
